    ...
    <div>
        <div className={classes.middlePart}>
            ...
            <div className={classes.buttonArea}>
                <Link className={classes.link1}  to="/en/contact-me"><button className={classes.button1}  >Fa o comandă</button></Link>
                <Link className={classes.link2}  to="/en/my-services"> <button className={classes.button2} > Află mai multe </button> </Link>
            </div>
        </div>
    </div>
  )
